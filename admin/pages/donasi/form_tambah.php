				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Form Tambah<small>Donasi</small></h2>					
									<div class="clearfix"></div>
								</div>
								<div class="x_content">
									<br />
									<form method="post" action="../admin/pages/donasi/aksi_simpan.php" class="form-horizontal form-label-left">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="select2_single form-control" id="Nama" name="Nama" tabindex="-1">
													<option value="AK">-- Nama Donatur --</option>
													<?php
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="Jumlah" name="Jumlah" placeholder="Jumlah Donasi" required="required" class="form-control">
											</div>
										</div>										
										<div class="item form-group">
